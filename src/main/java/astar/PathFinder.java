...
public class PathFinder {
    ...
    public ArrayList<TileNode> StartPathFind(TileNode startNode, TileNode destinationNode)
    {
        ...
        while(openList.getSize() > 0 ) 
        {
            ...
            ITileNode currentNode = openList.poll();
            ...
            //Check if reached destinal node
            ...
            for(ITileNode neighbourNode : this.currentNodeNeighbours ) 
            {
                 ...
                 */
                ITileNode discSuccessorNode = openList.getNode(neighbourNode);
                if(discSuccessorNode != null) {
                    neighbourNode = discSuccessorNode;
                    inOpenSet = true;
                } else {
                    inOpenSet = false;
                }
